...
import com.phasetranscrystal.brealib.api.registry.BreaRegistries;

public class BreaElements {

    static {
        BreaRegistries.ELEMENTS.unfreeze(true);
    }
    ...
    public static Element createAndRegister(long protons, long neutrons, long halfLifeSeconds, String decayTo,
        ...
        BreaRegistries.ELEMENTS.register(BreaUtility.id(name), element);
        return element;
    }

    public static void init() {
        BreaRegistries.ELEMENTS.freeze();
    }

    public static Element get(String name) {
        return BreaRegistries.ELEMENTS.getValue(BreaUtility.id(name));
    }
}
